...
export default function PopupObjetivo({ onClose, onAñadir }) {
  ...
  const añadirYCerrar = () => {
    ...
    onAñadir(trimmed); // PASAMOS el texto seguro
    setNuevoObjetivo("");
    onClose();
  };
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ marginTop: "5px", fontSize: "12px", color: "#555" }}>
          {nuevoObjetivo.length}/{MAX_LENGTH} caracteres
        </div>
        <div style={{
          marginTop: "10px",
          display: "flex",
          ...
          <button
            ...
            style={{
              ...
              color: "#fff",
              cursor: nuevoObjetivo.trim() === "" ? "not-allowed" : "pointer",
              opacity: nuevoObjetivo.trim() === "" ? 0.5 : 1
            }}
          >
            Añadir
          </button>
